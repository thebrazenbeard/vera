...
This protocol supplements `docs/WORKSTREAM_TURN_TAKING_PROTOCOL_V1.md`.

Writer leases, exact-head handoffs, review separation, current permission, privacy boundaries, safety constraints, and explicit authorization requirements remain unchanged. The continuation syntax tells the user what should happen next; it does not itself grant authority for the protected action it names.
