...
class PublicHarvestRuntimeV2Tests(unittest.TestCase):
    def test_roots_public_harvest_is_live_inside_vera(self):
    ...
    def test_attune_public_harvest_preserves_influence_firewall(self):
    ...
    def test_intranel_public_harvest_is_importable(self):
        self.assertTrue(callable(intranel_admission.operation_digest))
        self.assertTrue(callable(intranel_admission.admit))

    def test_lantern_public_harvest_canonicalization_is_deterministic(self):
